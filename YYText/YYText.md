...
![](./layoutWithContainer.png)

接着翻到这个函数的定义处：

![](./layoutWithContainer2.png)
...
理解还是不够，等后续再来品读。不觉感叹 YY 实在太强了！今天理了理思路，让自己边写边读代码，不至于枯燥，同时供大家参考。得去睡觉了，晚安~~~~~
